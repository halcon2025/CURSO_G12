...
# Configurar localización a UTF-8 para asegurar que los caracteres especiales se manejen correctamente
...
<head>
    ...
    <title>Informaci&oacute;n de la Instancia EC2</title>
    <style>
        body {
...
<body>
    <h1>Informaci&oacute;n de la Instancia EC2</h1>
    ...
    <p>La IP p&uacute;blica de esta instancia es: <span class="highlight">$PUBLIC_IP</span></p>
</body>
</html>
EOL

# Reiniciar Apache para aplicar cualquier cambio
